        ...
        <div class="info">
          ...
          <div class="inline">
            <div class="row">
              ...
              <div class="col-75">
                <input type="text" id="director_name" name="director_name" class="col82" value="${director.director_name}" readonly>
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="text" id="director_birth" name="director_birth" class="col82" value="${director.director_birth}" placeholder="영화 감독을 적어주세요" readonly>
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="text" id="director_gender" name="director_gender" class="col82" value="${director.director_gender}" placeholder="출연한 배우들의 이름을 적어주세요" readonly>
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="text" id="d_trophy_list" name="d_trophy_list" class="col82" value="${director.d_trophy_list}" placeholder="출연한 배우들의 이름을 적어주세요" readonly>
                <button type="button" id="aBtn"><i class="fas fa-search"></i></button>
              </div>
            </div>
          </div>
