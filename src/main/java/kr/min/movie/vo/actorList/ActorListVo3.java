...
public class ActorListVo3 {
  ...
  public Integer getActor_id_3() {
    return actor_id_3;
  }
  public void setActor_id_3(Integer actor_id_3) {
    this.actor_id_3 = actor_id_3;
  }
  public Cast getCast() {
    return cast;
  }
  ...
  public String toString() {
    return "ActorListVo3 [m_actor_list_id=" + m_actor_list_id + ", actor_list=" + actor_list + ", actor_id_3=" + actor_id_3 + ", cast=" + cast + ", c_name=" + c_name + "]";
  }
