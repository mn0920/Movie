...
public class ActorListVo2 {
  ...
  public Integer getActor_id_2() {
    return actor_id_2;
  }
  public void setActor_id_2(Integer actor_id_2) {
    this.actor_id_2 = actor_id_2;
  }
  public Cast getCast() {
    return cast;
  }
  ...
  public String toString() {
    return "ActorListVo2 [m_actor_list_id=" + m_actor_list_id + ", actor_list=" + actor_list + ", actor_id_2=" + actor_id_2 + ", cast=" + cast + ", c_name=" + c_name + "]";
  }
