...
public class ActorListVo8 {
  ...
  public Integer getActor_id_8() {
    return actor_id_8;
  }
  public void setActor_id_8(Integer actor_id_8) {
    this.actor_id_8 = actor_id_8;
  }
  public Cast getCast() {
    return cast;
  }
  ...
  public String toString() {
    return "ActorListVo8 [m_actor_list_id=" + m_actor_list_id + ", actor_list=" + actor_list + ", actor_id_8=" + actor_id_8 + ", cast=" + cast + ", c_name=" + c_name + "]";
  }
