...
public class ActorListVo6 {
  ...
  public Integer getActor_id_6() {
    return actor_id_6;
  }
  public void setActor_id_6(Integer actor_id_6) {
    this.actor_id_6 = actor_id_6;
  }
  public Cast getCast() {
    return cast;
  }
  ...
  public String toString() {
    return "ActorListVo6 [m_actor_list_id=" + m_actor_list_id + ", actor_list=" + actor_list + ", actor_id_6=" + actor_id_6 + ", cast=" + cast + ", c_name=" + c_name + "]";
  }
