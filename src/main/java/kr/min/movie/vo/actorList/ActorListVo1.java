...
public class ActorListVo1 {
  ...
  public Integer getActor_id_1() {
    return actor_id_1;
  }
  public void setActor_id_1(Integer actor_id_1) {
    this.actor_id_1 = actor_id_1;
  }
  public Cast getCast() {
    return cast;
  }
  ...
  public String toString() {
    return "ActorListVo4 [m_actor_list_id=" + m_actor_list_id + ", actor_list=" + actor_list + ", actor_id_1=" + actor_id_1 + ", cast=" + cast + ", c_name=" + c_name + "]";
  }
